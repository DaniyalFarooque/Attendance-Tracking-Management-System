...
//chart1.php
// for creating chart for a course on a particular date
...
foreach($result as $row)
{
  ...
  // store in putput - student name and its attendance status
	$output .= '
		<tr>
...
// if matched row > 0, then calculate percentage
if($total_row > 0)
{
